...
from dashboard.terrain_phase import group_by_phase, phase_for, phase_name
...
def test_phase_names_match_the_five_rs():
    assert [phase_name(n) for n in (1, 2, 3, 4, 5)] == [
        "Recharge", "Rejuvenate", "Regenerate", "Reclaim", "Regulate"]
...
def test_phase_for_still_answers_but_hides_the_second():
    ...
    from dashboard.terrain_phase import phase_for, phases_for
